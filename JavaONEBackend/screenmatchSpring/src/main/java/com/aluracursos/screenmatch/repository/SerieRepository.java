...
//    List<Serie> findByTotalTemporadasLessThanEqualAndEvaluacionGreaterThanEqual(int totalTemporadas, Double evaluacion);
    ...
    @Query("SELECT e FROM Serie s JOIN s.episodios e WHERE s = :serie ORDER BY e.evalacion DESC LIMIT 5")
    ...
    List<Episodio> obtenerTemporadasPorNumero(Long id, Long numTemporada);
}
